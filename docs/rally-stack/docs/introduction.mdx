...
<AccordionGroup>
  <Accordion icon="sitemap" title="130+ Reusable Modules">
  ...
  <Accordion icon="sitemap" title="Four-Layer Architecture">
  ...
  <Accordion icon="chart-bar" title="Modern Tech Stack">
...
<CardGroup cols={3}>
  ...
  <Card title="Nonprofit" icon="users">
    Donor management, grants, programs, volunteers
  </Card>
  <Card title="SPM" icon="chart-bar">
  ...
  <Card title="UI Components" icon="code">
  ...
  <Card title="Brand & Content" icon="code">
...
<CardGroup cols={2}>
  ...
  <Card title="Accelerate MVP Development" icon="chart-bar">
    Go from idea to working prototype in days, not months
  </Card>
  <Card title="Scale with AI" icon="rocket">
